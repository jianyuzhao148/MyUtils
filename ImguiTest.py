...
def load_fonts(app_state: AppState):  # This is called by runnerParams.callbacks.LoadAdditionalFonts
    ...
    app_state.title_font = hello_imgui.load_font("fonts/Roboto/Roboto-BoldItalic.ttf", 18,
                                                 font_loading_params_title_icons)
    ...
    app_state.large_icon_font = hello_imgui.load_font("fonts/fontawesome-webfont.ttf", 24.,
                                                      font_loading_params_large_icon)
...
def demo_fonts(app_state: AppState):
    ...
    imgui.text_wrapped(
        "Mix icons " + icons_fontawesome_6.ICON_FA_FACE_SMILE + " and text " + icons_fontawesome_6.ICON_FA_ROCKET)
    if imgui.is_item_hovered():
...
def setup_my_theme():
    ...
    hello_imgui.apply_tweaked_theme(
        tweaked_theme)  # Note: you can also push/pop the theme in order to apply it only to a specific part of the Gui:  hello_imgui.push_tweaked_theme(tweaked_theme) / hello_imgui.pop_tweaked_theme()
